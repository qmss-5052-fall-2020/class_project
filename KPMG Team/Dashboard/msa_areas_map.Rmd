...
# get FIPS codes (state + county)
# fips(state = "CA", county = "Orange") 

# FIPS county codes to Lat Long
geoFips <- function() {
...
table(c(county_map_US$statefp, county_map_US$state))
