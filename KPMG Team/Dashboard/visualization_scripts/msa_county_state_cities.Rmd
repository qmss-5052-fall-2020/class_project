...
state_covid_sum_merge <- state_covid_sum %>% 
...
plot_grid(TX, CA, FL, NY, IL, GA, ncol = 2)
...
plot_grid(TX_msa, CA_msa, FL_msa, IL_msa, MA_msa, NJ_msa, ncol = 2)


# ggsave("metro-state.png")
```
### Metropolitan Cases  
