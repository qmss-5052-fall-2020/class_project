...
just_sex <- read.csv("just_sex")
age_breakdown_manistee <- read.csv("age_breakdown_manistee")
race_data_manistee <- read.csv("race_data_manistee")
```
